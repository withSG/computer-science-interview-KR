...
SOLID는 "지켜야 할 규칙 5개"가 아니라 **코드 냄새를 진단하는 다섯 개의 렌즈**입니다.
...
**왜 문제인가**: `Rectangle`의 암묵적 계약은 "너비와 높이는 독립적으로 변한다"인데 `Square`가 이걸 깼습니다. **상속 관계는 현실의 분류가 아니라 계약의 호환성으로 판단해야 합니다.**
