...
**3. 서버 푸시**
- HTML 요청 시 CSS, JS를 미리 전송 (현재는 주요 브라우저가 지원을 제거했고 `103 Early Hints`가 대안)
...
예: Unix Non-blocking 소켓(O_NONBLOCK) + read() 반복 호출
```
-->
