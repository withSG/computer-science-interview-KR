...
> 자기소개가 왜 "인사"가 아니라 면접 전체의 질문 목록을 결정하는 장치인지, 1분과 3분 버전을 어떻게 다르게 짜는지, 그리고 지원 동기를 회사 조사와 어떻게 잇는지 설명할 수 있게 됩니다.
...
면접은 대체로 자기소개로 시작합니다. [qna-frontend-companies.md](./qna-frontend-companies.md)에 정리된 기업별 질문 목록에서도 A·B·C 기업이 모두 이 질문을 일반 질문의 첫 항목에 두고 있습니다. 그런데 많은 지원자가 이 시간을 "본론 전 워밍업"으로 취급합니다.

실제로 벌어지는 일은 다릅니다. 면접관은 지원자가 말하는 동안 이력서 여백에 키워드를 적습니다. 그리고 그 키워드에서 질문을 뽑습니다.
...
**자기소개에 넣은 단어가 곧 그날의 시험 범위가 된다.** 이게 자기소개를 설계해야 하는 이유입니다. 준비된 지원자는 자기가 자신 있는 주제로 면접관을 안내하고, 준비 안 된 지원자는 설명 못 하는 기술 이름을 흘려서 스스로 함정을 팝니다.

### 비유: 영화 예고편

자기소개는 예고편입니다. 본편(면접 본론)에서 무엇을 보게 될지 미리 알려주고, 관객이 계속 앉아 있게 만드는 역할을 합니다.

> **비유의 한계**: 예고편은 결말을 감추지만 자기소개는 반대입니다. 가장 강한 카드를 숨겼다가 나중에 꺼내면 그 "나중"이 오지 않습니다. 면접 시간이 끝나거나 면접관의 관심이 다른 데로 넘어갑니다. 강한 것부터 앞에 둡니다.
...
세 덩어리 각각이 다른 질문에 답합니다. **[1]이 없으면 상대가 나를 분류하지 못하고, [2]가 없으면 주장만 남고, [3]이 없으면 "아무 데나 넣었구나"가 된다.**
...
1. **이력서에 이미 다 있는 정보다.** 면접관 손에 이력서가 들려 있습니다. 낭독은 시간 낭비이고 "말할 게 그것뿐인가"라는 인상을 남깁니다.
2. **"배웠습니다"만 있고 "했습니다"가 없다.** 배운 것은 자격이 아닙니다. 그 기술로 무엇을 만들어 어떤 문제를 풀었는지가 실력의 근거입니다.
3. **키워드를 던져놓고 회수하지 않는다.** 자바·파이썬·C·리액트·타입스크립트·Next.js가 다 나왔습니다. 면접관은 이 중 아무거나 고를 수 있고, 가장 약한 것을 고를 확률이 높습니다.
4. **"성실", "책임감"은 정보량이 0이다.** 반대로 말하는 지원자가 없는 형용사는 변별력이 없습니다.
5. **[3]이 없다.** 이 자기소개는 어느 회사에 제출해도 똑같습니다.
...
**주의**: 이 방식은 심어놓은 키워드에 대해 3단계 꼬리 질문까지 준비돼 있어야 성립합니다. "가상화를 어떻게 구현하셨나요?"에 답을 못 하면 오히려 역효과입니다. 자신 있는 것만 심어라.

---

## 3. 1분 버전과 3분 버전

면접관이 "간단히 소개해주세요"라고 하면 1분, "자유롭게 말씀해주세요"라고 하거나 임원 면접이면 3분에 가깝습니다. 두 버전은 길이가 아니라 **구조가 다르다.**
...
> 표 요약: **3분 버전은 1분 버전에 내용을 덧붙인 게 아니라, 1분 버전의 각 문장을 한 단계씩 파고든 것**입니다. 새로운 항목을 추가해 분량을 채우면 늘어집니다. 만들 때는 3분을 먼저 쓰고 1분으로 깎는 편이 쉽습니다.
...
**타이머를 켜고 소리 내어 읽어봐야 한다.** 글로 쓸 때 1분 같던 원고가 말로는 2분이 되는 일이 흔합니다. 긴장하면 말이 빨라지는 사람은 원고를 더 짧게 잡아야 합니다.
...
[문제]-[역할]-[결과]만 말하면 "시킨 걸 해냈다"까지만 전달됩니다. [선택]이 들어가야 **판단할 줄 아는 사람**이 됩니다. 면접관이 실제로 알고 싶은 건 "이 사람에게 새 문제를 맡겼을 때 스스로 결정할 수 있는가"이고, 그 근거가 여기서 나옵니다.
...
"Next.js를 쓴 이유"는 실제로 자주 나오는 질문입니다. 자기소개에서 Next.js를 언급했다면 위 수준의 답이 준비돼 있어야 합니다. 프로젝트 서술을 더 깊이 다루는 방법은 [03-portfolio-project.md](./03-portfolio-project.md)에서 이어집니다.
...
지원 동기가 설득력을 가지려면 세 층이 다 있어야 합니다. 하나라도 빠지면 흔한 실패 유형 중 하나가 됩니다.
...
**왜 문제인가**: [A]가 사실이 아니라 수식어입니다. "선도", "성장"은 회사 이름만 바꾸면 어디든 붙습니다. [B]가 아예 없고 [C]는 "성장하고 싶다"뿐인데, 이건 회사가 나에게 주는 것이지 내가 회사에 주는 것이 아닙니다. 지원 동기를 물었는데 수혜 희망만 답한 셈입니다.
...
**주의**: 블로그 글을 언급하면 그 글에 대한 질문이 따라올 수 있습니다. 제목만 보고 인용하지 말고 반드시 끝까지 읽어라. 인용은 조사의 증거인 동시에 검증 대상입니다.
...
> 표 요약: 공통 원인은 **검증 불가능한 형용사입니다. 형용사를 지우고 동사와 사건으로 바꾸면 대부분 해결됩니다.
...
부트캠프나 학원을 거쳤다면 "어떤 곳이었나요"를 실제로 묻는 회사가 있습니다. 커리큘럼을 읊는 답에는 정보가 없습니다. 같은 기수 수십 명이 똑같이 말할 내용이기 때문입니다. 답해야 할 것은 그 안에서 **내가 따로 고른 부분**입니다. 커리큘럼 밖에서 파본 주제, 팀 프로젝트에서 자원해서 맡은 역할, 수료 후에도 혼자 이어간 작업 같은 것들. 변별은 정해진 과정이 아니라 거기서 벗어난 지점에서 생깁니다.

### 경력 전환자

가장 자주 받는 질문은 "왜 바꿨나요"이고, 그 뒤에 숨은 질문은 **"또 바꾸지 않을까"다**. 그래서 답은 이전 일에 대한 불만이 아니라 개발로 향하는 이유여야 합니다.
...
자기소개 다음으로 반복되는 세 질문입니다. 셋 다 자기소개와 같은 원리로 답합니다. 형용사가 아니라 사건에서 출발합니다.

### 강점

강점은 단어 하나가 아니라 **행동 서술 + 그 행동을 한 사건 + 직무 연결** 세 조각으로 만듭니다.
...
약점 질문은 자기 비판 능력을 보는 게 아니라 **자기 인식**을 봅니다. 그래서 실패하는 답이 세 종류입니다.
...
안전한 형태는 **실제 약점 + 그것을 관리하는 장치 + 최근에 달라진 점**입니다. "추정으로 코드를 고치다 시간을 버리는 일이 있어서, 지금은 30분 안에 원인이 안 좁혀지면 로그부터 다시 보는 규칙을 정해뒀습니다"처럼 관리 방법이 붙으면 약점이 오히려 성장 가능성의 근거가 됩니다.

### 5년 후

"5년 뒤 어떤 개발자가 되고 싶나요"는 야망을 재는 질문이 아니라 **그 그림을 여기서 그릴 수 있는가**를 확인하는 질문입니다. 직급("팀장이 되고 싶습니다")보다 역량과 역할로 답하는 편이 안전합니다. 지금 하고 있는 것 → 그 방향의 다음 단계 → 이 회사에서 할 수 있는 부분 순으로 이으면 지원 동기의 [C]층과 그대로 연결됩니다.

---

## 9. 실무에서는

- **자기소개는 원고를 통째로 외우지 말고 문장 3~4개의 뼈대만 외운다.** 통암기는 한 단어가 막히면 전체가 멈추고, 낭독 톤이 그대로 드러납니다. 뼈대만 있으면 면접 분위기에 맞춰 살을 조절할 수 있습니다.
- **비대면 면접에서는 원고를 화면 옆에 띄워두고 싶어지지만 권장하지 않는다.** 시선이 카메라에서 벗어나는 게 그대로 보이고, 읽는 사람 특유의 억양이 나옵니다. 키워드 몇 개만 포스트잇에 적어두는 정도가 낫습니다.
- **다대다 면접에서 앞 지원자와 소재가 겹치는 상황이 흔하다.** 같은 부트캠프 출신이면 프로젝트까지 비슷할 수 있습니다. 이럴 때 차별점은 프로젝트 이름이 아니라 그 안에서 내가 내린 결정이므로, [선택] 조각을 준비해둔 사람만 살아남습니다.
- **자기소개 직후 "방금 말씀하신 것 중에 ~"로 이어지는 경우가 흔하다.** 마지막 문장에 가장 자신 있는 키워드를 두면 그쪽으로 유도될 확률이 올라갑니다.
...
A. 현재 좌표 한 문장 → 강점과 그것을 증명하는 구체적 사건 → 지원 연결 순으로 1분 안에 마칩니다. 이력서에 이미 적힌 학력과 수료 이력은 반복하지 않습니다. 핵심은 **자신 있는 키워드 2개만 남기고 나머지를 버리는 것**입니다. 언급한 기술은 전부 질문 대상이 되므로, 설명할 자신이 없는 이름은 아예 꺼내지 않습니다.
- 꼬리 질문: "방금 말씀하신 OO은 왜 그렇게 하셨어요?" → 자기소개에 심은 키워드마다 문제-역할-선택-결과가 준비돼 있어야 합니다.

**Q. 왜 프론트엔드(백엔드) 개발자가 되기로 했나요?** (실제 출제 질문)

A. "적성에 맞아서" 같은 추상적 답 대신 계기가 된 사건 하나를 듭니다. 처음 만든 화면이 실제로 동작했을 때의 경험이든, 업무 자동화 스크립트가 팀에 쓰인 경험이든, **구체적이면 진정성이 따라온다.** 이어서 그 뒤로 무엇을 했는지(학습 기간, 만든 것)를 붙이면 일시적 흥미가 아니라는 증거가 됩니다.
- 꼬리 질문: "다른 직군은 고려 안 하셨나요?" → 고려했다면 솔직히 말하고 왜 지금 직군으로 좁혔는지 기준을 설명하는 편이 자연스럽습니다.

**Q. 왜 우리 회사인가요?**

A. 조사한 구체적 사실 → 내 경험과의 접점 → 하고 싶은 일 3층 구조로 답합니다. 회사 이름을 다른 회사로 바꿔도 성립하는 문장이면 다시 써야 합니다. 기술 블로그 글, 실제로 써본 서비스의 특정 기능처럼 **검증 가능한 사실**에서 출발하는 것이 핵심입니다.
...
자기소개는 인사가 아니라 그날의 시험 범위를 내가 제안하는 시간이므로, 현재 좌표 → 증거 있는 강점 → 지원 연결 구조로 자신 있는 키워드만 남겨 설계하고, 지원 동기는 회사 이름을 바꾸면 성립하지 않는 구체적 사실에서 출발해야 합니다.
