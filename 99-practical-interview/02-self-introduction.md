...
**자기소개에 넣은 단어가 곧 그날의 시험 범위가 됩니다.** 이게 자기소개를 설계해야 하는 이유입니다. 준비된 지원자는 자기가 자신 있는 주제로 면접관을 안내하고, 준비 안 된 지원자는 설명 못 하는 기술 이름을 흘려서 스스로 함정을 팝니다.
...
1. **이력서에 이미 다 있는 정보입니다.** 면접관 손에 이력서가 들려 있습니다. 낭독은 시간 낭비이고 "말할 게 그것뿐인가"라는 인상을 남깁니다.
2. **"배웠습니다"만 있고 "했습니다"가 없습니다.** 배운 것은 자격이 아닙니다. 그 기술로 무엇을 만들어 어떤 문제를 풀었는지가 실력의 근거입니다.
3. **키워드를 던져놓고 회수하지 않습니다.** 자바·파이썬·C·리액트·타입스크립트·Next.js가 다 나왔습니다. 면접관은 이 중 아무거나 고를 수 있고, 가장 약한 것을 고를 확률이 높습니다.
4. **"성실", "책임감"은 정보량이 0입니다.** 반대로 말하는 지원자가 없는 형용사는 변별력이 없습니다.
...
면접관이 "간단히 소개해주세요"라고 하면 1분, "자유롭게 말씀해주세요"라고 하거나 임원 면접이면 3분에 가깝습니다. 두 버전은 길이가 아니라 **구조가 다릅니다.**
...
> 표 요약: 공통 원인은 **검증 불가능한 형용사**입니다. 형용사를 지우고 동사와 사건으로 바꾸면 대부분 해결됩니다.
...
- **자기소개는 원고를 통째로 외우지 말고 문장 3~4개의 뼈대만 외웁니다.** 통암기는 한 단어가 막히면 전체가 멈추고, 낭독 톤이 그대로 드러납니다. 뼈대만 있으면 면접 분위기에 맞춰 살을 조절할 수 있습니다.
- **비대면 면접에서는 원고를 화면 옆에 띄워두고 싶어지지만 권장하지 않습니다.** 시선이 카메라에서 벗어나는 게 그대로 보이고, 읽는 사람 특유의 억양이 나옵니다. 키워드 몇 개만 포스트잇에 적어두는 정도가 낫습니다.
- **다대다 면접에서 앞 지원자와 소재가 겹치는 상황이 흔합니다.** 같은 부트캠프 출신이면 프로젝트까지 비슷할 수 있습니다. 이럴 때 차별점은 프로젝트 이름이 아니라 그 안에서 내가 내린 결정이므로, [선택] 조각을 준비해둔 사람만 살아남습니다.
