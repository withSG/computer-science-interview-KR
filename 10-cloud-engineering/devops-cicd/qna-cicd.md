...
```
"CI/CD를 도입해서 배포 주기를 2주에서 하루로 줄였습니다.
PR을 만들면 린트, 테스트, 빌드가 자동으로 실행되고
main 브랜치에 머지되면 스테이징 환경에 자동 배포됩니다.
...
### 핵심 답변
GitOps는 인프라와 애플리케이션을 선언적으로 관리하는 방식입니다. **Git을 Single Source of Truth로 사용**합니다.
