...
> 비유의 한계 — 온도조절기는 센서 하나와 히터 하나뿐이지만, 쿠버네티스는 수십 종류의 컨트롤러가 각자 다른 리소스를 감시하며 동시에 돌아갑니다. 그래서 "지금 이 상태를 누가 왜 바꿨는가"를 추적하는 일이 온도조절기와 비교할 수 없이 어렵습니다. 이벤트와 감사 로그를 보는 습관이 필요합니다.
