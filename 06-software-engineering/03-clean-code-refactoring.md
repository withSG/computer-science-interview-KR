...
마틴 파울러의 비유에 따르면 코드를 만질 때 쓸 수 있는 모자는 두 개, **기능 추가 모자**와 **리팩터링 모자**입니다. 규칙은 하나뿐입니다. 둘을 동시에 쓰지 않습니다.
...
- **보이스카웃 규칙**: "처음 왔을 때보다 깨끗하게 해두고 떠난다." 별도의 리팩터링 스프린트를 잡는 방법도 있습니다. 그런데 기능 작업 중 지나가는 파일에서 이름 하나·함수 하나를 고치는 편이 실제로는 훨씬 많이 정리됩니다. 별도 스프린트는 우선순위 경쟁에서 늘 밀립니다.
