...
### 핵심 답변
벡터 데이터베이스는 특수 목적 데이터베이스입니다. 쓰임새는 **고차원 벡터를 저장하고 유사도 기반 검색을 효율적으로 수행**하는 데 있습니다.
...
### 핵심 답변
ANN은 **정확한 최근접 이웃 대신 근사값을 빠르게 찾는** 알고리즘입니다. 정확도는 약간 내주고 속도를 크게 얻습니다.
...
### 핵심 답변
메타데이터 필터링은 **유사도 검색과 조건 필터를 결합**하는 기능입니다. 덕분에 더 정확한 결과를 얻습니다.
